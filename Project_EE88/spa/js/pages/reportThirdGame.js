  ...
  SpaPages.reportThirdGame = {
    getHTML: function () {
      return (
        ...
        '<input type="text" name="date" id="rt_dateRange" placeholder="' +
        ...
        '<select name="platform_id" lay-filter="rt_platform_id" lay-search>' +
        providerOptions +
        '</select></div></div>' +
      ...
      function renderTotalData(totalData) {
        ...
        fields.forEach(function (key) {
          ...
          if (val === undefined || val === null) {
            val =
              dataKey === 'total_bet_times' || dataKey === 'total_bet_number'
                ? '0'
                : '0.0000';
          }
      ...
      table.render({
        ...
        cols: [
          [
            ...
            {
              field: 'platform_id_name',
              title: HubLang.t('provider'),
              minWidth: 130
            },
            {
              field: 't_bet_amount',
            ...
            {
              field: 't_bet_times',
              title: HubLang.t('betTimes'),
              minWidth: 100
            },
            {
              field: 't_turnover',
              title: HubLang.t('turnover'),
              minWidth: 140
            },
        ...
        .on('click', function () {
          setTimeout(function () {
            ...
            table.reload('rt_dataTable', {
              where: { date: '', username: '', platform_id: '' },
              page: { curr: 1 }
            });
          }, 50);
        });
