  ...
  SpaPages.withdrawalsRecord = {
    getHTML: function () {
      return (
        ...
        '<legend data-i18n="withdrawHistoryTitle">' +
        HubLang.t('withdrawHistoryTitle') +
        '</legend>' +
        ...
        '</label>\uff1a' +
        '<div style="width:200px;" class="layui-input-inline">' +
        '<input type="text" name="serial_no" placeholder="' +
        HubLang.t('enterSerialNo') +
        '" class="layui-input" autocomplete="off">' +
        '</div></div>' +
        // date range
        '<div class="layui-inline">' +
        ...
        '<input type="text" name="create_time" id="wr_createTime" placeholder="' +
