  ...
  SpaPages.reportFunds = {
    getHTML: function () {
      return (
        ...
        '<input type="text" name="date" id="rf_dateRange" placeholder="' +
    ...
    init: function (container) {
      ...
      function renderTotalData(totalData) {
        if (!totalData) return;
        var fields = [
          'rf_total_deposit_amount',
          'rf_total_withdrawal_amount',
          'rf_total_charge_fee',
          'rf_total_agent_commission',
          'rf_total_promotion',
          'rf_total_third_rebate',
          'rf_total_third_activity_amount'
        ];
      ...
      table.render({
        ...
        cols: [
          [
            ...
            {
              field: 'deposit_count',
              title: HubLang.t('depositCountCol'),
              minWidth: 160
            },
            {
              field: 'deposit_amount',
              title: HubLang.t('depositAmountTotal'),
              minWidth: 150,
              sort: true
            },
            {
              field: 'withdrawal_count',
              title: HubLang.t('withdrawCountCol'),
              minWidth: 150
            },
            {
              field: 'withdrawal_amount',
              title: HubLang.t('withdrawAmountTotal'),
              minWidth: 160
            },
            {
              field: 'charge_fee',
              title: HubLang.t('chargeFee'),
              minWidth: 150
            },
            {
              field: 'agent_commission',
              title: HubLang.t('agentCommission'),
              minWidth: 150
            },
            {
              field: 'promotion',
              title: HubLang.t('promotion'),
              minWidth: 150
            },
            {
              field: 'third_rebate',
              title: HubLang.t('thirdRebate'),
              minWidth: 150
            },
            {
              field: 'third_activity_amount',
              title: HubLang.t('thirdActivityAmount'),
              minWidth: 150
            },
            {
              field: 'date',
              title: HubLang.t('dateCol'),
              minWidth: 160,
              fixed: 'right'
            },
