  ...
  SpaPages.depositAndWithdrawal = {
    getHTML: function () {
      return (
        ...
        '<legend data-i18n="depositWithdrawTitle">' +
        HubLang.t('depositWithdrawTitle') +
        '</legend>' +
        '<div class="layui-field-box">' +
        '<form class="layui-form" lay-filter="dw_searchForm">' +
        '<div class="layui-inline">' +
        '<label data-i18n="accountName">' +
        HubLang.t('accountName') +
        '</label>\uff1a' +
        ...
        '</div>' +
        '<div class="layui-inline">' +
        '<label data-i18n="time">' +
        HubLang.t('time') +
        '</label>\uff1a' +
        '<div style="width:220px;" class="layui-input-inline">' +
        '<input type="text" name="create_time" id="dw_createTime" placeholder="' +
        HubLang.t('dateStartEnd') +
        '" class="layui-input" readonly autocomplete="off">' +
        '</div>' +
        '</div>' +
        '<div class="layui-inline">' +
        '<label data-i18n="typeCol">' +
        HubLang.t('typeCol') +
        '</label>\uff1a' +
        '<div class="layui-input-inline">' +
        '<select name="type" lay-filter="dw_type">' +
        '<option value="" data-i18n="all">' +
        HubLang.t('all') +
        '</option>' +
        '<option value="1" data-i18n="deposit">' +
        HubLang.t('deposit') +
        '</option>' +
        '<option value="2" data-i18n="withdraw">' +
        HubLang.t('withdraw') +
        '</option>' +
        '</select>' +
        '</div>' +
        ...
        HubLang.t('all') +
        '</option>' +
        '<option value="0" data-i18n="statusPending">' +
        HubLang.t('statusPending') +
        '</option>' +
        '<option value="1" data-i18n="statusDone">' +
        HubLang.t('statusDone') +
        '</option>' +
        '<option value="2" data-i18n="statusProcessing">' +
        HubLang.t('statusProcessing') +
        '</option>' +
        '<option value="3" data-i18n="statusFailed">' +
        HubLang.t('statusFailed') +
        '</option>' +
        '</select>' +
        '</div>' +
        '</div>' +
        ...
        '<i class="hi hi-magnifying-glass"></i> <span data-i18n="search">' +
        HubLang.t('search') +
        '</span>' +
        '</button>' +
        '</div>' +
        ...
        '<i class="hi hi-arrows-rotate"></i> <span data-i18n="reset">' +
        HubLang.t('reset') +
        '</span>' +
        '</button>' +
        '</div>' +
      ...
      table.render({
        ...
        cols: [
          [
            ...
            {
              field: 'type',
              title: HubLang.t('typeCol'),
              width: 80,
              templet: function (d) {
                return d.type == '1'
                  ? HubLang.t('typeDeposit')
                  : HubLang.t('typeWithdraw');
              }
            },
            { field: 'amount', title: HubLang.t('amount'), width: 130 },
            {
              field: 'true_amount',
              title: HubLang.t('trueAmount'),
              width: 130
            },
            {
              field: 'status',
            ...
            {
              field: 'create_time',
              title: HubLang.t('createTime'),
              width: 160
            },
            {
              field: 'success_time',
              title: HubLang.t('successTime'),
              width: 160
            },
            ...
            {
              field: 'name',
              title: HubLang.t('accountHolderShort'),
              width: 150
            },
            ...
            {
              field: 'transfer_time',
              title: HubLang.t('transferTime'),
              width: 160
            },
            { field: 'remark', title: HubLang.t('remark'), width: 150 },
            {
              field: 'user_remark',
              title: HubLang.t('userRemark'),
              width: 150
            },
            { field: 'prostatus', title: HubLang.t('proStatus'), width: 120 },
            {
              field: 'prize_amount',
              title: HubLang.t('prizeAmount'),
              width: 120
            },
            {
              field: 'activity_id',
              title: HubLang.t('activityId'),
              width: 110
            },
            { field: 'extra', title: HubLang.t('extraInfo'), width: 150 },
            {
              field: 'category_id',
              title: HubLang.t('categoryId'),
              width: 100
            },
            {
              field: 'merchant_id',
              title: HubLang.t('merchantId'),
              width: 110
            },
            ...
            {
              field: 'review_time',
              title: HubLang.t('reviewTime'),
              width: 160
            },
            {
              field: 'transfer_record',
              title: HubLang.t('transferRecord'),
              width: 150
            },
        ...
        btnReset.addEventListener('click', function () {
          setTimeout(function () {
            ...
            table.reload('dw_dataTable', {
              where: { username: '', create_time: '', type: '', status: '' },
              page: { curr: 1 }
            });
          }, 50);
        });
