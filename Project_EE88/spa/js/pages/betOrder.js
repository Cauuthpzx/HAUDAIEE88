  ...
  SpaPages.betOrder = {
    getHTML: function () {
      return (
        ...
        ' placeholder="' +
        HubLang.t('enterPlatformAccount') +
        '"' +
        ' class="layui-input" autocomplete="off">' +
        '</div></div>' +
        '<div class="layui-inline">' +
      ...
      if (btnReset) {
        btnReset.addEventListener('click', function () {
          setTimeout(function () {
            ...
            if (betTimeEl) betTimeEl.value = '';
            table.reload('betOrder_dataTable', {
              where: { bet_time: '', serial_no: '', platform_username: '' },
              page: { curr: 1 }
            });
          }, 50);
        });
