  ...
  SpaPages.bet = {
    getHTML: function () {
      ...
      return (
        ...
        '<option value="" id="bet_optToday" data-i18n="today">' +
        t('today') +
        '</option>' +
        '<option value="" id="bet_optYesterday" data-i18n="yesterday">' +
        t('yesterday') +
        '</option>' +
        '</select>' +
        '</div></div>' +
        ...
        t('select') +
        '</option>' +
        '<option value="-9" data-i18n="betStatusUnpaid">' +
        t('betStatusUnpaid') +
        '</option>' +
        '<option value="1" data-i18n="betStatusWon">' +
        t('betStatusWon') +
        '</option>' +
        '<option value="-1" data-i18n="betStatusLost">' +
        t('betStatusLost') +
        '</option>' +
        '<option value="2" data-i18n="betStatusDraw">' +
        t('betStatusDraw') +
        '</option>' +
        '<option value="3" data-i18n="betStatusCancelUser">' +
        t('betStatusCancelUser') +
        '</option>' +
        '<option value="4" data-i18n="betStatusCancelSystem">' +
        t('betStatusCancelSystem') +
        '</option>' +
        '<option value="5" data-i18n="betStatusAbnormal">' +
        t('betStatusAbnormal') +
        '</option>' +
        '<option value="6" data-i18n="betStatusUnpaidManual">' +
        t('betStatusUnpaidManual') +
        '</option>' +
        '</select>' +
        '</div></div>' +
        // Search button
        ...
        '<div>' +
        '<span style="font-weight:bold;" data-i18n="summaryData">' +
        t('summaryData') +
        '</span>' +
        '<table class="layui-table" lay-even lay-skin="nob">' +
        '<thead><tr>' +
        '<th data-i18n="totalBetMoney">' +
        t('totalBetMoney') +
        '</th>' +
        '<th data-i18n="totalRebateAmount">' +
        t('totalRebateAmount') +
        '</th>' +
        '<th data-i18n="totalWinLose">' +
        t('totalWinLose') +
        '</th>' +
        '</tr></thead>' +
        '<tbody><tr>' +
        ...
        $.ajax({
          ...
          success: function (res) {
            if (res.data && res.data.playTypeData) {
              var html =
                '<option value="">' + HubLang.t('select') + '</option>';
      ...
      table.render({
        ...
        cols: [
          [
            ...
            {
              field: 'create_time',
              title: HubLang.t('betTime'),
              minWidth: 160
            },
            { field: 'lottery_name', title: HubLang.t('game'), minWidth: 150 },
            {
              field: 'play_type_name',
              title: HubLang.t('gameType'),
              minWidth: 150
            },
            {
              field: 'play_name',
              title: HubLang.t('playStyle'),
              minWidth: 150
            },
